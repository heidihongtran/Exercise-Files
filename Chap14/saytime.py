...
class numwords(): # numwords class returns a number as words.
    '''
        return a number as words,
        e.g., 42 becomes 'forty-two'
    '''
    #Design data before writing the code so the code us much easier:
    #_words list is a dictionary of tuples.
    _words = {
        'ones': (
...
class saytime(numwords): # saytime class inherits from numwords class
    '''
...
class saytime_t(saytime):  #special class saytime_t, inherits from saytime.
    # wrapper for saytime to use time object
    '''
